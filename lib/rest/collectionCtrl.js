...
function handle(response, collectionOptions) {
  ...
  var responseBody = {
    ...
    last: generateCollectionUrl(
      baseUrl,
      getLastOffset(limit, totalNumberOfItems),
      limit),
  };
